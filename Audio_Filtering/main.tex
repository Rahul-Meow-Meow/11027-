...
\begin{lstlisting}
https://github.com/Rahul-Meow-Meow/11027-/blob/main/Audio_Filtering/codes/Rahul-Singing.wav\end{lstlisting}
\item 
\label{Python code}
...
\href{https://academo.org/demos/spectrum-analyzer}{\url{https://academo.org/demos/spectrum-analyzer}} \\
...
\begin{figure}[ht]
    ...
    \caption{Spectrogram of the audio file before Filtering(at 0:09)}
    \label{fig:Before_Filtering}
\end{figure}
\begin{figure}[ht]
\includegraphics[width=0.8\columnwidth]{figs/Audio_After_Filtering.png}
    \caption{Spectrogram of the audio file after Filtering(at 0:09)}
...
\begin{lstlisting}
https://github.com/Rahul-Meow-Meow/11027-/blob/main/Audio_Filtering/codes/2_2.c
\end{lstlisting} 
The following code plots \eqref{prob:2.1} and \eqref{prob:2.2}
\begin{lstlisting}
https://github.com/Rahul-Meow-Meow/11027-/blob/main/Audio_Filtering/codes/2.2.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Rahul-Meow-Meow/11027-/blob/main/Audio_Filtering/codes/3.5.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Rahul-Meow-Meow/11027-/blob/main/Audio_Filtering/codes/4.2.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Rahul-Meow-Meow/11027-/blob/main/Audio_Filtering/codes/4.4.py
\end{lstlisting}
\begin{figure}[!ht]
\centering
...
%
\begin{lstlisting}
https://github.com/Rahul-Meow-Meow/11027-/blob/main/Audio_Filtering/codes/4.5.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Rahul-Meow-Meow/11027-/blob/main/Audio_Filtering/codes/5_sol.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Rahul-Meow-Meow/11027-/blob/main/Audio_Filtering/codes/5.4.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Rahul-Meow-Meow/11027-/blob/main/Audio_Filtering/codes/5.5.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Rahul-Meow-Meow/11027-/blob/main/Audio_Filtering/codes/6.1.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\end{align}
\begin{lstlisting}
https://github.com/Rahul-Meow-Meow/11027-/blob/main/Audio_Filtering/codes/6.2.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Rahul-Meow-Meow/11027-/blob/main/Audio_Filtering/codes/6_filter_response.py
\end{lstlisting}
\begin{figure}[H]
\centering
